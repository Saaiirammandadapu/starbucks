...
pickle_in = open("C:/Users/saaii/MP/df.pkl","rb")
...
def main():
    st.title("StarBucks Inc. Stock price Pridiction")
    html_temp = """
    <div style="background-color:rgb(0, 238, 255);padding:10px">
    <h2 style="color:rgb(255, 124, 37);text-shadow: 0 4px 10px rgba(0, 0, 0, 0.603);text-align:center;">SBUX Inc.Predicted Closed Price</h2>
    </div>
    """
